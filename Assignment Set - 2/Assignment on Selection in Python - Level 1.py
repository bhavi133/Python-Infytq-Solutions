Link : https://infytq.onwingspan.com/en/viewer/hands-on/lex_auth_012693711503400960120_shared?collectionId=lex_auth_0125409616243425281061_shared&collectionType=Course

Problem Statement : Write a python program to find and display the product of three positive integer values based on the rule mentioned below:
